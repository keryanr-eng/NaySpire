...
export const POTION_ART: Record<string, string> = {
...
export const RELIC_ART: Record<string, string> = {
...
export function getPotionArt(id: string | null | undefined): string | undefined {
  return id ? POTION_ART[id] : undefined;
}

export function getRelicArt(id: string | null | undefined): string | undefined {
  return id ? RELIC_ART[id] : undefined;
}

export function getItemArt(id: string | null | undefined): string | undefined {
